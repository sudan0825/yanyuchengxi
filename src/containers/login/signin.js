        ...
        return (<div className={mystyle.loginpage}>
          {console.log("this.props.authRedirectPath",this.props.authRedirectPath)}
            ...
            <form > 
                ...
                <div><Link to="signup" onClick={this.props.deleteError}>New User? Please click here to register</Link></div>
                <div className={mystyle.passwordRetrieve}><Link to="signup" onClick={this.props.deleteError}>Forget Password? Please click here to retrieve</Link></div>
            </form>
